...
def registerPage(request): 
    ...
    return render(request, 'base/login_reigster.html', {'form': form})
...
def home(request):
    ...
    room_messages = Message.objects.all().order('-created').filer(Q(room__topic__name__icontains=q))
